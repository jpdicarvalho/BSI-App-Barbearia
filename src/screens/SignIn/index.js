...
export default function Login() {
  ...
  return (
    <Container>
      ...
      <Text style={{ fontWeight: 'bold', fontSize: 20, color: '#fff', marginTop: 20 }}>Bem Vindo</Text>
      <Text style={{ fontWeight: 'bold', fontSize: 12, color: '#fff', marginTop: 5 }}>Faça login</Text>
